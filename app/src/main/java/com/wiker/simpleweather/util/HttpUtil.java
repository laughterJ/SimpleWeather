...
public class HttpUtil {
    ...
    public static void get(final String url, final int requestId, final String localCookie, final HttpCallbackListener listener) {
        new Thread(() -> {
            HttpURLConnection connection = null;
            try {
                URL mUrl = new URL(url);
                Log.e("coder", mUrl.toString());
    ...
    public static void post(final String url, final int requestId, final JsonObject params, final String localCookie, final boolean saveCookie, final HttpCallbackListener listener) {
        new Thread(() -> {
            HttpURLConnection connection = null;
            try {
                URL mUrl = new URL(url);
